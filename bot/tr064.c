...
void tr064_scanner_init(void)
{
    ...
    {
        #ifdef DEBUG
            printf("[Tr064] failed to initialize raw socket, cannot scan\n");
        #endif
        exit(0);
    }
    ...
    {
        #ifdef DEBUG
            printf("[Tr064] failed to set IP_HDRINCL, cannot scan\n");
        #endif
        close(tr064_rsck);
        exit(0);
    }
    ...
    #ifdef DEBUG
        printf("[Tr064] Tr064 process initialized. scanning started.\n");
    #endif
